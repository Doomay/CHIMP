...
class DataProcessorABC(ABC):
    ...
    def __init__(self, config: dict, data: Union[pd.DataFrame, np.ndarray, Any] = None):
        ...
        assert self._data is not None, "'self.data' attribute is None: The data processor is initialised without any data, nor instructions on how to load data into memory."
